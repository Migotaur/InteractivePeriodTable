...
class CompoundsActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.nav_compounds -> drawerLayout.close()
        }
        return true
    }
